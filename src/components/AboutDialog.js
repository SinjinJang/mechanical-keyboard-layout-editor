          ...
          <DialogContentText id='about-dialog-description'>
            ...
            <ul>
              <li>2022/10/03: <u>무료 서버 사용으로 인한 제약 사항</u>
                <ul>
                  <li>도면 생성 작업(STL/DXF)을 요청하시면 해당 요청 건이 작업 대기열에 등록되고, 등록된 작업들은 <b>19:00~23:00 [KST]</b> 사이에 순차적으로 처리됩니다.</li>
                  <li>많은 키들을 배치하실 경우 <b>도면 생성이 오래</b> 걸립니다. (layout-full 기준 약 40분)</li>
                  <li>위 처리 시간 및 도면 생성 시간을 참고하여 사용하시기 바랍니다. 대기열 작업 종료 즈음에 오래 걸리는 작업을 요청하시면 중간에 취소될 수 있습니다.</li>
                </ul>
              </li>
            </ul>
          </DialogContentText>
